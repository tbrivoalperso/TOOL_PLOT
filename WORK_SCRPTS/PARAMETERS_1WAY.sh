...
export FLDR_VERSION1=/scratch/work/brivoalt/RUNS_NEMO/eNEATL36_AGRIF_vvl/EXP01_AGRIF_emodNET_finaldomain_topped_update_test_smooth2_1WAY
...
# LISTS OF PLOTS 
# On mother domain
export scripts_motherdomain="MAP_SST.py MAP_KE.py MAP_MLD.py MAP_SSS.py" 
export scripts_motherdomain_cmp="MAP_SST_CMP.py MAP_KE_CMP.py MAP_MLD_CMP.py MAP_SSS_CMP.py"

# On agrif
export scripts_agrif="" #  MAP_KE.py MAP_MLD.py MAP_SSS.py"
