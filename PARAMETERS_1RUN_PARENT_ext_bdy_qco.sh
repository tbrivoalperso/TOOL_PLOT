...
export FLDR_VERSION1=/scratch/work/brivoalt/RUNS_NEMO/eNEATL36_AGRIF_vvl/EXP01_AGRIF_emodNET_finaldomain_update_PARENT_EXT_BDY_qco
export FLDR_VERSION2=
export CFG_NAME="eNEATL36"
export AGRIF_CFG_NAME="1_AGRIF"
export VER1="qco_PARENT_ext"
export VER2=
...
# SCRIPTS DIRECTORIES
export OUT_DIR=/scratch/work/brivoalt/PLOTS/PLOTS_AGRIF/PARENT_ext_bdy_qco # Where to plot
...
export scripts_gifs="MAP_SST_GIFS.py MAP_KE_GIFS.py " #MAP_VOR_GIFS_manche.py" #"MAP_SST_GIFS_manche.py" #"MAP_SST_GIFS.py MAP_KE_GIFS.py MAP_VOR_GIFS.py" 
