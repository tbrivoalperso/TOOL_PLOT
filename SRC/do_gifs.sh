...
while [ "$d" != "$enddate" ]; do 
     ...
     if $AGRIF
     then
       TFILENM=${AGRIF_CFG_NAME}_1h_${gridT_1h_name}_${datefmt}-${datefmt}.nc
       UFILENM=${AGRIF_CFG_NAME}_1h_${gridU_1h_name}_${datefmt}-${datefmt}.nc
       VFILENM=${AGRIF_CFG_NAME}_1h_${gridV_1h_name}_${datefmt}-${datefmt}.nc
       FFILENM=${AGRIF_CFG_NAME}_1h_curl_${datefmt}-${datefmt}.nc
   
     else
       TFILENM=${CFG_NAME}_1h_${gridT_1h_name}_${datefmt}-${datefmt}.nc
       UFILENM=${CFG_NAME}_1h_${gridU_1h_name}_${datefmt}-${datefmt}.nc
       VFILENM=${CFG_NAME}_1h_${gridV_1h_name}_${datefmt}-${datefmt}.nc
       FFILENM=${CFG_NAME}_1h_curl_${datefmt}-${datefmt}.nc
       FSONFILENM=${AGRIF_CFG_NAME}_1h_curl_${datefmt}-${datefmt}.nc
...
then
  ...
  echo "process gif on files :" ${SCRIPTID}_${CFG_NM}_1h_${VER}_*.png
  convert -delay 30 -loop 0 ${SCRIPTID}_${CFG_NM}_1h_${VER}_*.png ${SCRIPTID}_${CFG_NM}_1h_${VER}.gif
  #convert -delay 30 -loop 0 -quality 20 ${SCRIPTID}_${CFG_NM}_1h_${VER}_*.png ${SCRIPTID}_${CFG_NM}_1h_${VER}_q20.gif
  mv ${SCRIPTID}_${CFG_NM}_1h_${VER}.gif ${OUT_DIR}/
fi
