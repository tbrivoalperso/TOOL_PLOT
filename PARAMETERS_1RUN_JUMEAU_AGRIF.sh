...
export FLDR_VERSION1=/scratch/work/brivoalt/RUNS_NEMO/eNEATL36/eNEATL36_trunk_r4.2-RC_r15113_IFS_EXP_JUMEAU_AGRIF_nornf
export FLDR_VERSION2=
export CFG_NAME="eNEATL36"
export AGRIF_CFG_NAME="1_AGRIF"
export VER1="eNEATL36"
export VER2=
export IS_AGRIF_VER1=false
...
# SCRIPTS DIRECTORIES
export OUT_DIR=/scratch/work/brivoalt/PLOTS/PLOTS_AGRIF/JUMEAU_AGRIF # Where to plot
