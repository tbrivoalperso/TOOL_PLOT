...
def rolling31j_KE(idate):
    ds = xr.open_dataset('FLDR/CFG_NM_1h_gridV.nc')
    format2='%Y%m%d'
    ...
    print(sdate2, edate2)
    U = ds.somecrty.sel(time_counter=slice(sdate2, edate2))
    print('U loaded')
...
#
    ...
    print('ok')
    U_roll_day.to_netcdf('FLDR/eNEATL36_1h_gridV_rolling24_'+idate_str+'.nc')
    U_subday.to_netcdf('FLDR/eNEATL36_1h_gridV_subdaily_'+idate_str+'.nc')

    print('write FLDR/eNEATL36_1h_gridV_rolling24_'+idate_str+'.nc    OK')
    print('write FLDR/eNEATL36_1h_gridV_subdaily_'+idate_str+'.nc    OK')
