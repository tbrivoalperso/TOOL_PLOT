...
def filter_hourly_KE(idate):
    ...
    my_file = Path('FLDR/eNEATL36_1h_KE_filt20'+idate_str+'_daymean.nc')
    if my_file.is_file():
        print('FLDR/eNEATL36_1h_KE_filt20'+idate_str+'_daymean.nc already exists, next')
    else:
        print(idate_str)
        ...
        KE.to_netcdf('FLDR/eNEATL36_1h_KE_filt20'+idate_str+'_daymean.nc')
        print('write FLDR/eNEATL36_1h_KE_filt20'+idate_str+'_daymean.nc    OK')
