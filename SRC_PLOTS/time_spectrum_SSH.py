...
ssh_1_file = xr.open_dataset('FLDR/CFG_NM_1h_grid2D.nc') #, chunks={'time': 10})
...
plt.savefig('CFG_NM_time_spectrum_freq_VER1_DSTART_DEND.png')
plt.close()



ax = plt.subplot(111)
ax.plot((1/mean_f0_ssh_1)/3600,mean_fi0_ssh_1, 'k', lw=2, label ='VER')
ax.set_yscale('log')
ax.set_xscale('log')
ax.legend()
...
plt.savefig('CFG_NM_time_spectrum_period_VER1_DSTART_DEND.png')
plt.close()
