...
for areanm in AREANAMES:
    ...
    if do_comp:
        ...
        plt.savefig(DIR_PLOT_EXP+areanm+"_TEMP_RMS_NOOBS"+RUNid1+"_"+RUNid2+".png")
        print("fig saved here :", DIR_PLOT_EXP+areanm+"TEMP_RMS_NOOBS"+RUNid1+"_"+RUNid2+".png")
        plt.close()
    else:
        ...
        ax.set_ylabel("DEPTH (m)")
        ax.set_title("RMSE on T°")
        plt.savefig(DIR_PLOT_EXP+areanm+"_TEMP_RMS_NOOBS"+RUNid1+".png")
        print("fig saved here :", DIR_PLOT_EXP+areanm+"_TEMP_RMS_NOOBS"+RUNid1+".png")
        plt.close()
    ...
    if do_comp:
        ...
        plt.savefig(DIR_PLOT_EXP+areanm+"_TEMP_BIAS_NOOBS"+RUNid1+"_"+RUNid2+".png")
        print("fig saved here :", DIR_PLOT_EXP+areanm+"_TEMP_BIAS_NOOBS"+RUNid1+"_"+RUNid2+".png")
        plt.close()
    else:
        ...
        ax.set_ylabel("DEPTH (m)")
        ax.set_title("BIAS on T°")
        plt.savefig(DIR_PLOT_EXP+areanm+"_TEMP_BIAS_NOOBS"+RUNid1+".png")
        print("fig saved here :", DIR_PLOT_EXP+areanm+"_TEMP_BIAS_NOOBS"+RUNid1+".png")
        plt.close()
    ...
    if do_comp:
        ...
        plt.gca().invert_yaxis()
        plt.tight_layout()
        plt.savefig(DIR_PLOT_EXP+areanm+"_TEMP_RMS_diff_NOOBS"+RUNid1+"_"+RUNid2+".png")
        print("fig saved here :", DIR_PLOT_EXP+areanm+"_TEMP_RMS_diff_NOOBS"+RUNid1+"_"+RUNid2+".png")
        plt.close()
    ...
    if do_comp:
        ...
        plt.gca().invert_yaxis()
        plt.tight_layout()
        plt.savefig(DIR_PLOT_EXP+areanm+"_TEMP_BIAS_diff_NOOBS"+RUNid1+"_"+RUNid2+".png")
        print("fig saved here :", DIR_PLOT_EXP+areanm+"_TEMP_BIAS_diff_NOOBS"+RUNid1+"_"+RUNid2+".png")
        plt.close()
