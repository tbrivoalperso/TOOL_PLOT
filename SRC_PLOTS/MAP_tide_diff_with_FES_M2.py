...
zx=Ufile_FES.M2_z1.squeeze().values
zy=-Ufile_FES.M2_z2.squeeze().values
...
cbar.set_label('M2 amplitude difference (m)', rotation=270, labelpad=12, fontsize=15,fontweight="bold")
...
plt.savefig('CFG_NM_tide_M2_diff_FES_VER_DSTART_DEND.png')
