...
Tfile_VER1 = xr.open_dataset('FLDR_VERSION1/CFG_NM_1d_gridT.nc', chunks={'time_counter': 50})
Tfile_VER2 = xr.open_dataset('FLDR_VERSION2/CFG_NM_1d_gridT.nc', chunks={'time_counter': 50})
...
im1 = plt.contourf(lon, lat, T_VER2 - T_VER1 ,levels=np.linspace(-0.7,0.7,51), cmap=mymap,transform=ccrs.PlateCarree(),extend='both')
...
plt.tight_layout()
plt.savefig('CFG_NM_SST_moyenne_diff_VER2_m_VER1_DSTART_DEND.png')
plt.close()
