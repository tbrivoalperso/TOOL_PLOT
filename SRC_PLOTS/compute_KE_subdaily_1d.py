...
def subdaily_KE(idate):
    ...
    print(idate_str)
    ds_V = xr.open_dataset('FLDR/eNEATL36_1h_gridV_subdaily_'+idate_str+'.nc')#.sel(time_counter=idate_str)
    ds_U = xr.open_dataset('FLDR/eNEATL36_1h_gridU_subdaily_'+idate_str+'.nc')#.sel(time_counter=idate_str)
    ...
    #KE['time_counter'] = idate
    KE.to_netcdf('FLDR/eNEATL36_1d_KE_subdaily_'+idate_str+'.nc')
    print('write FLDR/eNEATL36_1d_KE_subdaily_'+idate_str+'.nc    OK')
...
#ds_V = xr.open_dataset('FLDR/eNEATL36_1h_gridV_subdaily'+idate_str+'.nc')
#ds_U = xr.open_dataset('FLDR/eNEATL36_1h_gridV_subdaily'+idate_str+'.nc')
