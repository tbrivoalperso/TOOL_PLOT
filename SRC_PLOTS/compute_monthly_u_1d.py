...
def rolling31j_KE(idate):
    ds = xr.open_dataset('FLDR/CFG_NM_1d_gridU25h.nc')
    format2='%Y%m%d'
    ...
    print(sdate2, edate2)
    U = ds.vozocrtx.sel(time_counter=slice(sdate2, edate2))
    print('U loaded')
...
#
    ...
    print('ok')
    U_roll_day.to_netcdf('FLDR/eNEATL36_1d_gridU25h_rolling31j_'+idate_str+'.nc')
    U_submon.to_netcdf('FLDR/eNEATL36_1d_gridU25h_submonthly_'+idate_str+'.nc')

    print('write FLDR/eNEATL36_1d_gridU25h_rolling31j_'+idate_str+'.nc    OK')
    print('write FLDR/eNEATL36_1d_gridU25h_submonthly_'+idate_str+'.nc    OK')
